...
const checkDogsFood = function (dogsArr) {
  return dogsArr.curFood > dogsArr.recommendedFood
    ? "dogs eat too much"
    : "Dogs eat too little";
};

console.log(checkDogsFood(sarahDogs));
...
// 5
const recommendedFood = dogs.some((dog) => dog.curFood === dog.recommendedFood);
console.log("recommendedFood", recommendedFood);

//6 eating ok amount of food
...
console.log(dogs.some(okeyFood));

// 7.  filter dogs with okey portion

console.log(dogs.filter(okeyFood));
